...
class AlienInvasion:
    ...
    def __init__(self):
        """Initialize the game, create game assets"""
    ...
    def _check_events(self):
        """Respond to the key press and mouse events"""
    ...
    def _check_bullet_alien_collisions(self):
         ...
         # Check for any bullets that have hit aliens. if so, get rid of bullet and the alien.
    ...
    def _update_aliens(self):
         ...
         # Look for alien-ship coliisions
    ...
    def _update_screen(self):
         ...
         # Make the most recently drawen screen visible
         pygame.display.flip()
